...
config :starter_kit, StarterKitWeb.Endpoint,
  ...
  # Errors render as JSON only by design — the web flavor and the JSON:API layer
  # both consume JSON, so there is no ErrorHTML view. Plain HTML routes fall back
  # to Phoenix's built-in error responses.
  render_errors: [
