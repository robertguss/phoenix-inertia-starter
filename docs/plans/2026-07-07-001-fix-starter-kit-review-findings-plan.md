...
- **KTD-R4. Update the Version Matrix to the shipped OTP 29 snapshot (F21).** Record Erlang 29.0.3 / Elixir 1.20.2-otp-29 as canonical (README + an erratum note in the origin plan's Version Matrix), noting it postdates the origin OTP-27 primary-source pass and matches the generated release Docker image.
